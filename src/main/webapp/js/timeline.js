...
(function($){
    // Entry
    $.fn.equipTimeLine = function(container,options) {
        var timeLine = new TimeScale(container, options);
...
//            _getDateForInterval(x);
            ...
            var element = $(this._svg("circle"))
                ...
                .attr("cy", cy)
                .attr("r", radius);
            var animation = $('<animate attributeName="r" attributeType="XML"' +
                'begin="0s" dur="5s" fill="freeze" from="0" to="'
                + radius +'"/>');
            animation.appendTo(element);
            this._setSvgOptions(element, options);
            return element;
...
//                    console.log(notReachArea);
                    ...
                    var newArea;
                    console.log('--------------------------------------------------');
                    console.log(elem.machinesDailyList.length);
                    console.log(xDelta);
                    console.log(parseFloat(notReachArea.attr("width")) - xDelta);
                    ...
                    if(elem.machinesDailyList.length === 1) {
                        console.log('--------------------------------------------------:::');
                        console.log(parseFloat(latestArea.attr('width')) + xDelta);
