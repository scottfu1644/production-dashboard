...
(function ($) {
    ...
    var _790 = {render: function (_791, _792, _793) {
        ...
        _7d8.html(this.renderTable(_7d6, 0, [
            {}
        ], false));
...
(function ($) {
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {groupHeight: 21, expanderWidth: 16, singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [
        [
    ...
    ], showGroup: false, groupView: _824, groupField: "group", groupFormatter: function (_861, rows) {
        return _861;
    }});
})(jQuery);
(function ($) {
...
(function ($) {
    function _935(_936) {
        ...
        $(_936).datagrid($.extend({}, opts, {cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [
            [
