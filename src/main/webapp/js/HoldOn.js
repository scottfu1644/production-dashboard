...
(function(window,$){'use strict';
    ...
    function HoldOnAction(){
            ...
            _holdon.open = function(properties){
                ...
                if(properties && properties.which) {
                    $(Holder).appendTo(properties.which).fadeIn(300);
                } else {
                ...
                if(properties){
                    ...
                    if(properties.custPosition) {
                        $("#holdon-overlay").css("position",properties.custPosition);
                    }
